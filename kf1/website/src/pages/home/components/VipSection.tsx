...
export default function VipSection() {
  ...
  return (
    <section id="vip" className="py-20 bg-gradient-to-b from-gray-900 to-black">
      <div className="container mx-auto px-4">
          ...
          <Card variant="blood" className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <i className="ri-server-fill text-red-400 text-3xl mb-3"></i>
              ...
              <div className="text-center">
                <i className="ri-code-fill text-red-400 text-3xl mb-3"></i>
              ...
              <div className="text-center">
                <i className="ri-team-fill text-red-400 text-3xl mb-3"></i>
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center gap-4">
            <button className="flex items-center gap-2 bg-gray-800 hover:bg-gray-700 text-white px-6 py-3 rounded-lg transition-colors cursor-pointer whitespace-nowrap">
